...
Protocol_1 <- pbmc@meta.data[pbmc@meta.data$Protocol == "2D-ESC", "Well_ID"]
mat_counts <- mat_counts[, !colnames(mat_counts) %in% Protocol_1]
...
```{r save-session}
saveRDS(adata, file = "../data/processed/03_VITRO-3D-Ach.rds")
write.csv(adata@meta.data, file = "../data/processed/03_VITRO-3D-Ach.metadata.csv")
```
